...
class _CreateNewMenuState extends State<CreateNewMenu> {
    ...
    return CardTile(
      ...
      children: [
        ...
        TextFormField(validator: (value) {
          ...
          newMenu['prices'] = int.parse(value);
        }
  ...
  void _buildMenuForm() {
    ...
    // Provider.of<ProviderMenu>(context, listen: false).createSubMenu(newMenuList);
    Provider.of<ProviderMenu>(context, listen: false).createMenu(newMenu);
