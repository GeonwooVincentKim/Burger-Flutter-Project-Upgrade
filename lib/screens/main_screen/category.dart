...
class _CategoryState extends State<Category> {
  ...
  Widget _buildCategoryBody() {
    return Container(
        ...
        child: Consumer<ProviderMenu>(builder: (ctx, category, child) {
          // final Map<String, dynamic> menuFilter = Provider.of<FilterProvider>(context, listen: false).orderFilters;
          ...
          return listCategory.length == 0
              ...
              : GridView.builder(
                  ...
                  itemBuilder: (context, index) =>
                      ListTileCategory(cate: listCategory[index])
