...
class _DetailsState extends State<Details> {
  ...
  void initState() {
    ...
    if (detailMenu == null) {
      final List<MenuModel> detailTitle =
          Provider.of<ProviderMenu>(context, listen: false).menuList.toList();
      ...
      child: Container(
          ...
          child: Column(
            children: <Widget>[
              ...
              Text("${detailMenu.prices.toString()} KRW",
                  style: detailTitleSize)
            ],
          )),
    );
  }
  ...
  Widget _buildImage(BuildContext context) {
    ...
    return Container(
        ...
        child: Stack(
          ...
          children: <Widget>[
            PositionedImage(
                selection: 1, bottom: centerLength * 2, left: centerLength),
            PositionedImage(
                selection: 0,
                bottom: basicLength,
                left: centerLength * 2,
                imagePath: detailMenu.image),
          ],
        ));
  }
                    ...
                    children: [
                      ...
                      Row(
                          ...
                          children: [
                            BottomButton(
                                contents: "OK",
                                onPressed: () => _buildSubmitForm(context)),
                            BottomButton(
                                contents: "CANCEL",
  ...
  void _buildSubmitForm(BuildContext context) {
    ...
    Provider.of<ProviderMenu>(context, listen: false).addMenu(detailMenu);
